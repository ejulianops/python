...
# The function should use a list comprehension technique to create and return a new list, 
# containing only those words from the original list which begin with a vowel (a, e, i, o, u). 
